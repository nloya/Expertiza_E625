...
#<<<<<<< HEAD
  attr_reader :student,:ta,:instructor,:administrator,:superadministrator, :manager, :reader   # Changes for E625
#=======
...
#<<<<<<< HEAD
    # Changes for E625
  def self.manager
    @@manager_role ||= find_by_name 'Manager'
  end

  def self.reader
    @@reader_role ||= find_by_name 'Reader'
  end
    # Changes for E625 ENDS
#=======
#>>>>>>> 4c68f52a7464e968a722335cb6340efbf1c65b0a
